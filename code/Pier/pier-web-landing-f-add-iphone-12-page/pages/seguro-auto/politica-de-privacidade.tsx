...
const DataPolicy = () => {
  ...
  return (
    <AutoLandingLayout
      pageTitle="Pier Seguro Auto - Conheça nossa política e segurança de dados"
      pageDescription="A proteção de seus dados é muito importante para nós. Saiba como a Pier se compromete com a segurança das suas informações."
      canonicalLink="https://www.pier.digital/seguro-auto/politica-de-privacidade"

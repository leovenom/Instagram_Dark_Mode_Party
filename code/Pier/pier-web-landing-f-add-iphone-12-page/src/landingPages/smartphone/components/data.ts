...
export default {
  ...
  pipeBanner: {
    descriptionOne: "💰 Psssiu...",
    descriptionTwo: (date: string) =>
      `A partir de ${date} haverá reajuste no valor de algumas mensalidades e reembolsos.`,
    switcherLabel: "Mostrar novos valores",
  },
};

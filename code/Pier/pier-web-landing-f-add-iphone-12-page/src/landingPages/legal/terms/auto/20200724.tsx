  ...
  <>
    <Item>
      ...
      <Paragraph>
        ...
        seguro emitido pela Too Seguros, sob número de Processo SUSEP
        15414.601042/2020-20
      </Paragraph>
    </Item>
    ...
    <Item>
      ...
      <Paragraph>
        O valor da mensalidade é conhecido pelo cliente no momento da
        contratação e será reajustado mensalmente com base nas atualizações da{" "}
        <ExternalLink
    ...
    <Item>
      ...
      <StyledOrderedList>
        <li>
          ...
          acrescido dos custos da Pier com o processamento do pagamento de
          indenizações;
        </li>
        <li>
          20% são destinados à remuneração da Too Seguros, que garante que os
          membros adimplentes sejam sempre indenizados; e
        </li>
        <li>
    ...
    <Item>
      <ItemTitle>4.​ Vistoria</ItemTitle>
      <Paragraph>
        A vistoria do automóvel será realizada digitalmente, no aplicativo da
        Pier. Para isso, serão pedidas fotos internas e externas do automóvel,
        além da foto do documento do carro (CRV, CLRV ou DUT). Após o envio da
        vistoria, analisaremos as fotos e voltaremos com uma resposta em até 48
        horas, prorrogáveis caso o envio de outros documentos seja necessário.
      </Paragraph>
    </Item>

    <Item>
      <ItemTitle>5. Pedido ​de indenização para Roubo/Furto</ItemTitle>
    ...
    <Item>
      <ItemTitle>5.1.​ Documentos adicionais</ItemTitle>
      <Paragraph>
        O reembolso será realizado em, no máximo, 20 dias úteis após a Pier
        constatar o envio de toda a documentação solicitada. Em alguns casos,
        esse prazo pode se estender a até 30 dias, conforme as normas da SUSEP,
        e documentos adicionais serão solicitados para conclusão da análise do
        pedido de reembolso. Em caso de esse prazo de 30 dias ser excedido, a
        Pier contabilizará ao pagamento as devidas correções e multa pelo seu
        próprio atraso.
      </Paragraph>
    </Item>

    <Item>
      <ItemTitle>5.2.​ Em caso de localização de veículo</ItemTitle>
      <Paragraph>
        Caso o veículo seja localizado, comunique imediatamente à Pier, mesmo
        que seja localizado sem quaisquer danos para que possamos orientá-lo
        sobre como proceder.
      </Paragraph>
    </Item>

    <Item>
      <ItemTitle>6.​ ​Casos compreendidos</ItemTitle>
      <StyledOrderedList>
        <li>Roubo e furto</li>
    ...
    <Item>
      <ItemTitle>7.​ ​Casos não compreendidos</ItemTitle>
    ...
    <Item>
      <ItemTitle>8. Valor da indenização</ItemTitle>
      <Paragraph>
    ...
    <Item>
      <ItemTitle>9. Cancelamento</ItemTitle>
      <Paragraph>
      ...
      <Item>
        ...
        <StyledOrderedList>
          ...
          <li>
            {" "}
            <ExternalLink
              href={`/seguro-auto/politica-de-dados?version=${currentVersion.dataPolicy.id}`}
              target="_blank"
              rel="noopener"
            >
              Política de Dados
